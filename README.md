...
Orchestrator is a web application built with ASP.NET Core APIs, designed to manage and coordinate software robots. It allows users to create tasks, assign them to robots, and collect execution results.
...
``` bash
git clone https://github.com/Rajfex/RobotOrchestrator.git
```
